                            ...
                            <div className="about-container">
                                <div className="newaboutgroup-text">
                                    ...
                                    <div className="newabout-text wow slideInRight" data-wow-duration="2s" data-wow-delay=".2s">
                                        My name is Joy Gospel and I am first a child of God, before anything else. Wait a minute, hold that thought before any conclusions are made, I am here to serve you. A people lover both in my specific purpose
